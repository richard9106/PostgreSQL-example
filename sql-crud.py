...
class Programmer(base):
    """creamos una clase base modelo para la tabla"""
    __tablename__ = "Pgrogrammer"
...
# programer = session.query(Programmer).filter_by(first_name=fname, last_name=lname).first()
# defensive programing
# if programer is not None:
#     print("Progra,,er Found: ", programer.first_name + " " + programer.last_name)
